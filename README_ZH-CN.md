...
<p align="center">
  ...
  <a href="https://gitee.com/jeanslw/devops_glue/releases/latest"><img src="https://img.shields.io/github/v/release/jeanslw/Devops-Glue?style=flat-square&label=Release" alt="Release"></a>
...
| 文档 | 语言 | 说明 |
|------|------|------|
| [API_文档](docs/API_文档.md) | 中文 | API 接口、请求/响应格式、快速测试 |
...
| [贡献指南](CONTRIBUTING_ZH-CN.md) | 中文 | 中英文档编写 / 翻译 / 同步维护规范 |
