...
return [
    ...
    'build.mode_note_1'     => 'Switching takes effect immediately and affects all subsequent build tasks.',
    'build.mode_note_2'     => 'Changing the build mode deactivates mappings that no longer match (demoted to Pending); unavailable options are disabled in the dropdown.',
