...
return [
    ...
    'admin.sidebar_push_records' => 'Custom_Push_Log',
    ...
    'index.feat_multi_build_desc'    => 'Jenkins · GitLab CI · Custom_Push — three CI sources unified. Pull-based and push-based CI coexist orthogonally under one API: trigger, status report, and logs are identical across engines.',
