...
return [
    ...
    'build.mode_required'   => 'mode must be one of jenkins / gitlab_ci / gitea_ci',
    ...
    'build.gitea_ci_unavail' => 'Gitea Actions is unavailable (base_url / token not configured), please check config',
    'build.mode_label'      => 'Build Mode',
    'build.mode_note_1'     => 'Multi-select; switching takes effect immediately and affects all subsequent build tasks.',
    'build.mode_note_2'     => 'Unchecking a CI deactivates its mappings (demoted to Pending); unconfigured CIs are hidden.',
    'build.custom_push_note_1' => 'User CI pushes build results; Devops-Glue only receives the callbacks.',
    'build.custom_push_note_2' => 'When turned off, active Custom_Push mappings are demoted to pending.',
    'build.stale_cleanup_note_on'  => 'On: Harbor is the source of truth — tag rows that no longer exist in Harbor are removed; Harbor tags themselves are never deleted.',
    'build.stale_cleanup_note_off' => 'Off: cleanup stops; the system may retain rows whose tags no longer exist.',
    'build.mode_jenkins'    => '⚡ Jenkins',
    'build.mode_gitlab_ci'  => '🐺 GitLab CI',
    'build.mode_gitea_ci'   => '🦎 Gitea Actions',
    'build.mode_custom_push' => '📤 Custom_Push',
    'build.custom_push_toggle' => '📤 Enable Custom_Push',
    'build.custom_push_no_provider' => 'No custom_providers configured in settings.php, cannot enable Custom_Push',
    'build.mode_both'       => 'Jenkins + GitLab',
    'build.mode_hint'       => 'Multi-select; changes take effect immediately. Unchecking a CI deactivates mappings that no longer match (demoted to Pending); unconfigured CIs are hidden.',
    'build.mode_saved'      => 'Saved',
    'build.stale_tag_cleanup_toggle' => '🧹 Enable stale tag record cleanup',
    'build.stale_tag_cleanup_title'  => 'Stale Tag Cleanup',
    'build.tag_log_keyword_title' => '🔍 Image Tag Log Keyword',
    'build.tag_log_keyword_note'  => 'When the "Image Tag" column misses the scan writeback, this keyword is matched against the build log to locate the push-success fragment (case-insensitive; separate multiple keywords with `|`; leave empty to restore the default "digest").',
    'build.backfill_tag_toggle'   => '🔄 Enable image tag log backfill',
    ...
    'push.pipeline_iid'    => 'pipeline_iid',
    'push.status'          => 'status',
    'push.sha'             => 'sha',
    'push.variables_json'  => 'variables_json',
    'push.log_url'         => 'log_url',
    'push.web_url'         => 'web_url',
    'push.finished_at'     => 'finished_at',
    'push.tag'             => 'tag',
    'push.no_records'      => 'No push records yet',
    'push.view_log'        => 'View log',
    'push.load_failed'     => 'Failed to load push records',
    'pull.project_label'   => 'Project',
    'pull.confirm_btn'     => 'Confirm',
    'pull.refresh'         => 'Refresh',
    'pull.select_first'    => 'Please select a project first',
    'pull.no_projects'     => 'No pull projects available',
    'pull.no_records'      => 'No build records for this project',
    'pull.load_failed'     => 'Failed to load build records',
    ...
    'pull.view'            => 'View',
    'pull.log'             => 'Log',
    'pull.log_title'       => 'Build Log',
    'pull.no_log'          => 'Log unavailable',
    ...
    'admin.sidebar_build_records' => 'Build Records',
    'admin.sidebar_pull_records'  => 'Pull Records',
    'admin.sidebar_push_records'  => 'Custom Push',
    'admin.sidebar_users'   => 'Users',
    'admin.sidebar_user_list' => 'User List',
    'admin.sidebar_roles'   => 'Roles',
    ...
    'index.feat_multi_build_title'   => 'Multi-Channel Build',
    'index.feat_multi_build_desc'    => 'Jenkins · GitLab CI · Gitea CI · Custom_Push — Four CI sources unified. Pull-based and push-based CI coexist orthogonally under one API: trigger, status report, and logs are identical across engines.',
    ...
    'index.feat_dashboard_desc'     => 'Web-based management: service health, project topology, mapping config, Build Log — all in one place. No config file editing needed — form-based operations get you started instantly.',
    'index.feat_api_title'          => 'Open API',
    'index.feat_api_desc'           => 'Complete RESTful API with Swagger docs, API Token auth and fine-grained scope control — third-party systems can integrate the full CI/CD flow seamlessly.',
    ...
    'js.mode_switch_note'        => 'This takes effect immediately and affects all subsequent build tasks. Mappings that no longer match will be demoted to pending.',
    'js.custom_push_enable_confirm' => 'Enable Custom_Push?',
    'js.custom_push_toggle_note'  => 'Once enabled, user CI can push build-result callbacks to Devops-Glue. When disabled, active Custom_Push mappings are demoted to pending.',
    'js.custom_push_disable_confirm' => 'Confirm disabling Custom_Push?',
    'js.stale_tag_cleanup_enable_confirm' => 'Confirm enabling stale tag cleanup?',
    'js.stale_tag_cleanup_disable_confirm' => 'Confirm disabling stale tag cleanup?',
    'js.stale_tag_cleanup_note'  => 'When enabled, rows whose tags no longer exist in Harbor are removed. When disabled, automatic cleanup stops and Harbor tags are never deleted.',
    'js.backfill_tag_enable_confirm' => 'Confirm enabling image tag log backfill?',
    'js.backfill_tag_disable_confirm' => 'Confirm disabling image tag log backfill?',
    'js.backfill_tag_note'  => 'When enabled, the backfill cron writes log-derived tags (verified to exist in Harbor) into artifact tag records, filling gaps only. When disabled, backfill stops.',
    ...
    'js.mode_select_all'        => 'Select All',
    'js.mode_none'              => 'No pull CI',
    'js.no_pull_ci'             => 'No pull CI configured',
    'js.jenkins_detected_version' => 'detected version',
    'js.jenkins_version_unknown'  => 'unknown',
    'js.mode_jenkins_name'      => 'Jenkins',
    'js.mode_gitlab_ci_name'    => 'GitLab CI',
    'js.mode_gitea_ci_name'     => 'Gitea Actions',
    'js.mode_custom_push_name'  => 'Custom_Push',
    'js.mode_harbor_name'       => 'Harbor',
    'js.mode_pull_title'        => 'Pull-based',
    'js.mode_pull_desc'         => 'Glue triggers CI; CI pulls code and pushes images',
    'js.mode_push_title'        => 'Push-based',
    'js.mode_push_desc'         => 'User CI builds & pushes images; Glue only receives the report',
    'js.mode_user_ci'           => 'User CI',
    ...
    'user.email'       => 'Email',
    'user.email_placeholder' => 'user@example.com (optional)',
    ...
    'user.cannot_create_super_admin' => 'Creating a super admin requires super admin privilege',
    ...
    'user.cannot_manage_non_cd' => 'Service account may only manage users belonging to the CD system',
    'user.cannot_verify_root'  => 'Verifying the built-in/super admin password via this API is not allowed',
    'user.verify_locked'       => 'Too many failed password verifications, try again in 15 minutes',
    ...
    'user.modify_password' => 'Change Password',
    'user.modify_password_hint' => 'Set a new password for {user} (min 8 chars)',
    'user.modify_password_confirm' => 'Confirm',
    'user.modify_password_mismatch' => 'Passwords do not match',
    'user.modify_password_forbidden' => 'Only super admin can change others\' passwords',
    'user.password_updated' => 'Password updated',

    // ── Role Management ──
    'role.in_use'       => 'Cannot delete role with active users',
    'role.no_users'     => 'No roles',
    'role.add_role'     => '+ Add Role',
    'role.edit_role'    => 'Edit Role',
    'role.name'         => 'Role ID',
    'role.name_required'=> 'Role ID is required',
    'role.name_placeholder' => 'Lowercase letters, numbers and underscores',
    'role.name_help'    => 'Lowercase letters, numbers, underscores',
    'role.description'  => 'Display Name',
    'role.desc_placeholder' => 'e.g. Builder',
    'role.type'         => 'Type',
    'role.permissions'  => 'Permissions',
    'role.delete_confirm' => 'Delete this role? Assigned users will lose these permissions.',
    'role.deleted'       => 'Role deleted',
    'role.system_role'  => 'System',
    'role.custom_role'  => 'Custom',
    'role.sys_cannot_edit'   => 'System role cannot be edited',
    'role.sys_cannot_delete' => 'System role cannot be deleted',
    'role.no_roles'     => 'No roles created yet',
    'role.no_perms_available' => 'No permissions available',
    'role.perm_ci_manage'             => 'CI Management',
    'role.perm_ci_users_manage'       => 'User Management',
    'role.perm_ci_users_list'         => 'User List',
    'role.perm_ci_users_password'     => 'Change Password',
    'role.perm_ci_users_manage_admin' => 'Roles',
    'role.perm_ci_permissions_manage'   => 'Permission Management',
    'role.perm_ci_permissions_list'     => 'Permission List',
    'role.perm_ci_permissions_register' => 'Permission Register',
    'role.perm_ci_permissions_rules'    => 'Implied Rules',
    'role.perm_ci_mapping_edit'       => 'Mapping Management',
    'role.perm_ci_platform_edit'      => 'Platform Versions',
    'role.perm_ci_mode_edit'          => 'Build Mode Config',
    'role.perm_ci_discover'           => 'Auto Discover',
    'role.perm_ci_trigger'            => 'Trigger Build',
    'role.perm_ci_build-records'      => 'Build Records',
    ...
    'role.perm_ci_system'             => 'System Info',
    'role.perm_cd_build-manage'       => 'Build Management',
    'role.perm_cd_deploy-manage'      => 'Deploy Management',
    'role.perm_cd_server-manage'      => 'Server Management',
    'role.perm_cd_webshell'           => 'Web Shell',
    'role.perm_cd_deploy-record'      => 'Deploy History',
    ...
    'role.perm_cd_monitor_app'         => 'App Resources',
    ...
    'api_token.add'             => '+ New Token',
    'api_token.name'            => 'Name',
    'api_token.name_placeholder'=> 'e.g. CD service account / Jenkins scan writeback',
    ...
    'api_token.created_hint'    => 'Copy and save it now — the plaintext token is shown only once.',
    'api_token.copy'            => 'Copy',
    'api_token.status'          => 'Status',
    'api_token.created_at'      => 'Created At',
    'api_token.empty'           => 'No tokens',
    'api_token.never'           => 'Never',
    'api_token.active'          => 'Active',
    'api_token.expired'         => 'Expired',
    'api_token.revoke'          => 'Revoke',
    'api_token.name_required'   => 'Name is required',
    'api_token.copied'          => 'Copied',
    'api_token.copy_failed'     => 'Copy failed',
    'api_token.confirm_revoke'  => 'Revoke this token? It becomes invalid immediately.',
    'api_token.revoked'         => 'Revoked',
    'api_token.delete'          => 'Delete',
    'api_token.confirm_delete'  => 'Delete this token? The record cannot be recovered.',
    'api_token.deleted'         => 'Deleted',
    'api_token.disabled'        => 'Disabled',
    'api_token.super_admin_only'=> 'Super admin only',
    'api_token.scope_forbidden' => 'API token lacks permission for this endpoint',
    'api_token.service_unavailable' => 'API token service unavailable',

    // API Token Scope catalog
    'api.scope.main'            => 'MAIN (read-only)',
    'api.scope.git'             => 'GIT (read-only)',
    'api.scope.harbor_read'     => 'Harbor read',
    'api.scope.harbor_scan'     => 'Harbor scan trigger',
    ...
    'oplog.result'             => 'Result',
    'oplog.time'               => 'Time',
    'oplog.success'            => 'Success',
    'oplog.failure'            => 'Failure',
    'oplog.operator_type'      => 'Operator type',
    'oplog.admin'              => 'Admin',
    'oplog.api_token'          => 'API Token',
    'oplog.result_all'         => 'All',
    'oplog.date_from'          => 'From',
    'oplog.date_to'            => 'To',
    'oplog.search'             => 'Search',
    'oplog.reset'              => 'Reset',
    'oplog.empty'              => 'No operation logs',
    'oplog.username_placeholder' => 'Search username',
    'oplog.action_placeholder'   => 'e.g. login / create_user',
    'oplog.act_login'          => 'Login',
    'oplog.act_login_failed'   => 'Login failed',
    'oplog.act_login_locked'   => 'Login locked',
    'oplog.act_logout'         => 'Logout',
    'oplog.act_change_password' => 'Change password',
    'oplog.act_auto_discover'  => 'Auto discover',
    'oplog.act_build_trigger'  => 'Trigger build',
    'oplog.act_build_retry'    => 'Retry build',
    'oplog.act_build_cancel'   => 'Cancel build',
    'oplog.act_create_mapping' => 'Create mapping',
    'oplog.act_update_mapping' => 'Update mapping',
    'oplog.act_delete_mapping' => 'Delete mapping',
    'oplog.act_update_platform_version' => 'Update platform version',
    'oplog.act_update_build_mode' => 'Update build mode',
    'oplog.act_create_user'    => 'Create user',
    'oplog.act_update_user'    => 'Update user',
    'oplog.act_reset_user_password' => 'Reset user password',
    'oplog.act_set_user_status' => 'Enable/disable user',
    'oplog.act_delete_user'    => 'Delete user',
    'oplog.act_create_role'    => 'Create role',
    'oplog.act_update_role'    => 'Update role',
    'oplog.act_delete_role'    => 'Delete role',
    'oplog.act_register_permission' => 'Register permission',
    'oplog.act_delete_permission' => 'Delete permission',
    'oplog.act_create_implied_rule' => 'Create implied rule',
    'oplog.act_delete_implied_rule' => 'Delete implied rule',
    'oplog.act_create_api_token' => 'Create API token',
    ...
    'sys.is_current'      => 'Schema Status',
    'sys.php_version'     => 'PHP Version',
    'sys.current'         => '✅ Up to date',
    'sys.outdated'        => '⚠️ Out of sync (migrate required)',
    'sys.none'            => '(not recorded)',
    'sys.tables'          => 'Core Tables',
    'sys.tables_toggle'   => '📋 Tables',
    'sys.platforms'       => 'Platform Status',
    'sys.configured'      => 'Configured',
    'sys.not_configured'  => 'Not configured',
    'sys.cred_set'        => 'Credential set',
    'sys.cred_unset'      => 'No credential',
    'sys.migrate_btn'     => '🛠 Migrate Database',
    'sys.migrate_confirm' => 'Run database migration now?',
    ...
    'sys.backup_list'     => 'Backup Files',
    'sys.backup_confirm'  => 'Run database backup now? A zip backup file will be created in the backups directory (backup only, no restore).',
